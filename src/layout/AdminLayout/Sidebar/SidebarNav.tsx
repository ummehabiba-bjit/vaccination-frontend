...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavGroup toggleIcon={faPuzzlePiece} toggleText="Appointments">
        <SidebarNavItem href="#">Appointment List</SidebarNavItem>
        <SidebarNavItem href="#">New Appointment</SidebarNavItem>
      </SidebarNavGroup>
